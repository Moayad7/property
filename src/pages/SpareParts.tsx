    ...
    <MainLayout>
      <div className="container-custom py-28">
        <div className="text-center mb-12">
          <h1 className="heading-2 mb-4">قطع غيار العقارات</h1>
          <p className="subtitle mx-auto">تسوق من تشكيلة واسعة من قطع الغيار الأصلية والبديلة لكافة موديلات العقارات. شحن سريع ودعم فني متخصص.</p>
        </div>
        ...
        <div className="bg-white shadow-md rounded-lg p-6 mb-8">
          ...
          {showFilters && (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6 pt-6 border-t border-border/50">
              <div>
                <h3 className="font-medium mb-3">ماركة العقار</h3>
                <Select>
                  <SelectTrigger>
              ...
              <div>
                <h3 className="font-medium mb-3">موديل العقار</h3>
                <Select>
                  <SelectTrigger>
